function [ Y I ] = ShuffleIt( X , DIM )
%SHUFFLE IT    Shuffles elements.
...
%   dimension of X. %%%%% MEJC needed this for my formtrials.m
%
...
% Renamed it ShuffleIt.m to avoid confusion with 'Shuffle' which only handles vector/matrix inputs  MEJC 23/806/2017 
%
